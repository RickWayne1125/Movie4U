...
ML_20M = "ml-20m"
ML_LATEST = "ml-latest"
DATASETS = [ML_1M, ML_20M, ML_LATEST]
...
DATASET_TO_NUM_USERS_AND_ITEMS = {ML_1M: (6040, 3706), ML_20M: (138493, 26744), ML_LATEST: (280000, 58000)}
...
def _regularize_latest_dataset(temp_dir):
  """
  ratings.csv
    Each line of this file after the header row represents one rating of one
    movie by one user, and has the following format:
  ...
  movies.csv
    ...
    MovieID,Title,Genres
      - MovieIDs range from 1 and 3952
  """
  working_dir = os.path.join(temp_dir, ML_LATEST)
